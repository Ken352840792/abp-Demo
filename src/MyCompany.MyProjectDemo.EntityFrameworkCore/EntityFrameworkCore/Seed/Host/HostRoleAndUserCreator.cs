...
namespace MyCompany.MyProjectDemo.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly MyProjectDemoDbContext _context;

        public HostRoleAndUserCreator(MyProjectDemoDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new MyProjectDemoAuthorizationProvider())
